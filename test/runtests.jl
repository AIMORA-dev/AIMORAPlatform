...
@testset "AIMORA Platform changed-package selection" begin
    @test affected_packages(PLATFORM_ROOT, ["packages/AIMORAProject.jl/src/AIMORAProject.jl"]) == ["AIMORAProject.jl"]
    @test affected_packages(PLATFORM_ROOT, ["packages/AIMORASymbols.jl/metadata/library.toml"]) == ["AIMORASymbols.jl"]

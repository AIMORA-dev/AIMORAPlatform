...
| --- | --- | --- |
| `AIMORAProject` | `AIMORAProject` | `6e87310f-3ba6-4e69-9b4a-8a1fcbcc0c12` |
| `AIMORAFormats` | `AIMORAFormats` | `55f26d86-12d8-41b3-b163-188390d0187e` |
| `AIMORALayout` | `AIMORALayout` | `6f047e7d-bf2a-40ac-a20c-c55cfda68ba0` |
| `AIMORAService` | `AIMORAService` | `54bbdfc6-6134-4d5a-90dd-4d1a26642ec2` |
| `AIMORAVisuals` | `AIMORAVisuals` | `60d64674-9081-4077-878f-44c1107ce075` |
| `AIMORAReporting` | `AIMORAReporting` | `79e9649d-112a-4870-83df-912117092548` |
| `AIMORASymbols` | `aimora-public-symbols` | content library `0.1.0`; no Julia package UUID |

Run `julia test/runtests.jl` for the repository contract. Run each Julia package’s normal `Pkg.test()` command for package-local behavior; the symbol library retains `julia AIMORASymbols/tests/runtests.jl`.

...
Contributions must preserve deterministic output, separate view state from physics, add geometry invariants and regression fixtures, and avoid solver dependencies.

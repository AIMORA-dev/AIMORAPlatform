...
Contributions must keep protocol versions explicit, preserve schema-generated semantics, avoid hidden model state and private source paths, and include compatibility tests.

...
Contributions must consume typed public results, keep renderer extensions optional, preserve units and accessibility metadata, and include backend-neutral tests.

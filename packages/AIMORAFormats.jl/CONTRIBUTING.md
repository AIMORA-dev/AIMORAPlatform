...
Contributions must preserve deterministic open-text semantics, retain source locations and diagnostics, add round-trip and adversarial tests, and avoid private solver dependencies.
